...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/bg_top.jpg">
  <tr>
    ...
    <td width="80" height="58">&nbsp;</td>
    <td style="font-size:40px;color: #CC0000">蒙牛挂牌系统</td>
    <td align="right" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="../images/hd_email.jpg" width="69" height="58" border="0"  onClick="tuichu()"></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<form name="form1" method="post" action="">
  <tr>
    ...
    <td class="F02"><img src="../images/person_header.jpg" width="9" height="31" align="absmiddle">${sessionScope.user.name},欢迎您！</td>
